...
void NRF24L01_RX_Mode(void)
{
  	...
  	NRF24L01_CE = 1; //CE为高,进入接收模式 
		delay_us(120);	 //等待120us进入接收模式
}				
// void NRF24L01_RX_Mode(void)
// {
// 	NRF24L01_CE=0;	  	    

// 	NRF24L01_Write_Reg(WRITE_REG_NRF+SETUP_AW,0X03);							//数据TX/RX 地址宽度5字节
// 	NRF24L01_Write_Buf(WRITE_REG_NRF+RX_ADDR_P0,(u8*)RX_ADDRESS,RX_ADR_WIDTH);	//写RX节点地址
// 	NRF24L01_Write_Reg(WRITE_REG_NRF+EN_AA,0x01);     							//通道0的自动应答 设置位 
// 	NRF24L01_Write_Reg(WRITE_REG_NRF+EN_RXADDR,0x01); 							//使能通道0的接收地址 
// 	NRF24L01_Write_Reg(WRITE_REG_NRF+SETUP_RETR,0x15);							//自动重发间隔时间 设置位

//   	NRF24L01_Write_Reg(WRITE_REG_NRF+RF_CH,0X28);      						 	//设置RF通道为40
// 	NRF24L01_Write_Reg(WRITE_REG_NRF+RX_PW_P0,RX_PLOAD_WIDTH);  				//选择通道0的有效数据宽度 
